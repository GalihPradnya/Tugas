    <main class="container mx-auto py-12 px-4 flex-1">
        <nav class="mb-6 text-sm">
            <a href="<?= base_url('beranda'); ?>" class="text-green-700 hover:underline">Beranda</a> &gt; <a
                href="<?= base_url('navbar/berita_pengumuman'); ?>" class="text-green-700 hover:underline">Berita & Pengumuman</a> &gt; <span
